...
if __name__ == '__main__':
    ...
    elif args[0] == 'top_neutral':
        ctrl.move(1, 470, 500)
        ctrl.move(2, 470, 500)
    elif args[0] == 'upper_leg' and args_num == 2:
        print(args[1])
        if args[1] == "reset":
            ctrl.move(2,500,500)
            ctrl.move(3,500,500)
        else:
            ctrl.move(2, int(args[1]), 500)
            ctrl.move(3, 500-(int(args[1])-500), 500)

    elif args[0] == 'lower_leg' and args_num == 2:
        print(args[1])
        if args[1] == "reset":
            ctrl.move(4,500,500)
            ctrl.move(5,500,500)
        else:
            ctrl.move(4, int(args[1]), 500)
            ctrl.move(5, 500-(int(args[1])-500), 500)
    elif args[0] == 'custom_leg' and args_num == 4:
        print(args[1])
        if args[1] == "reset":
            ctrl.move(int(args[2]), 500, 500)
            ctrl.move(int(args[3]), 500, 500)
        else:
            ctrl.move(int(args[2]), int(args[1]), 500)
            ctrl.move(int(args[3]), 500 - (int(args[1]) - 500), 500)
